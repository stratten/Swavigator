...
const titleBarIconButtonStyle: CSSProperties = {
...
const titleBarRowStyle: CSSProperties = {
  gap: "8px",
};
...
export function TitleBar({
  ...
  return (
    <div
      ...
      className="flex flex-col flex-shrink-0 cursor-grab"
      style={{
    ...
    >
      {/* Group 1: title + Swavigator window/behavior controls. */}
      <div
        data-tauri-drag-region
        className="flex flex-wrap items-center"
        style={{ columnGap: "4px", rowGap: "6px" }}
      >
        <span
          data-tauri-drag-region
        ...
        <div
          ...
          style={{ ...titleBarRowStyle, marginLeft: "auto" }}
        >
      ...
      {/* Group 2: view/navigation controls. */}
      <div
        className="flex flex-wrap items-center justify-end"
        style={titleBarRowStyle}
      >
          {/* View mode toggle */}
          <button
      ...
      {/* Group 3: utilities. Search stays last. */}
      <div
        className="flex flex-wrap items-center justify-end"
        style={titleBarRowStyle}
      >
          ...
          {/* Search toggle — last in source and visual order. */}
          <button
